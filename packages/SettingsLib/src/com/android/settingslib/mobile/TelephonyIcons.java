...
public class TelephonyIcons {
    ...
    public static final int ICON_LTE = R.drawable.mod_ic_lte_mobiledata;
    public static final int ICON_LTE_PLUS = R.drawable.mod_ic_lte_plus_mobiledata;
    public static final int ICON_G = R.drawable.mod_ic_g_mobiledata;
    public static final int ICON_E = R.drawable.mod_ic_e_mobiledata;
    public static final int ICON_H = R.drawable.mod_ic_h_mobiledata;
    public static final int ICON_H_PLUS = R.drawable.mod_ic_h_plus_mobiledata;
    public static final int ICON_3G = R.drawable.mod_ic_3g_mobiledata;
    public static final int ICON_4G = R.drawable.mod_ic_4g_mobiledata;
    ...
    public static final int ICON_4G_PLUS = R.drawable.mod_ic_4g_plus_mobiledata;
    public static final int ICON_5G_E = R.drawable.mod_ic_5g_e_mobiledata;
    public static final int ICON_1X = R.drawable.mod_ic_1x_mobiledata;
    public static final int ICON_5G = R.drawable.mod_ic_5g_mobiledata;
    public static final int ICON_5G_PLUS = R.drawable.mod_ic_5g_plus_mobiledata;
    public static final int ICON_CWF = R.drawable.mod_ic_carrier_wifi;
    public static final int ICON_5G_NSA = R.drawable.mod_ic_5g_nsa_mobiledata;
